...
import com.oriental.domain.OrderStatus;
import com.oriental.domain.OrderType;
import com.oriental.modal.*;
import com.oriental.repository.OrderItemRepository;
import com.oriental.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order createOrder(User user, OrderItem orderItem, OrderType orderType) {
        ...
        order.setTimeStap(LocalDateTime.now());
